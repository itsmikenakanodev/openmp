...
float reduccion_paralela3(float *input, const int n, binary_op op) {
    int num_threads;
...
int main() {
    ...
    fmt::println("Reduccion paralela1: {}", suma2);
    ...
    auto suma4=reduccion_paralela3(datos.data(),datos.size(), op_add);
    fmt::println("Reduccion 4: {}", suma4);
    return 0;
}